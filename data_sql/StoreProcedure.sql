...
/*
	...
	AUTOR				: TEOFILO CHAMBILLA AQUINO
	ARGUMENTOS			: IDMETA
	FEC. MODIFIC		: 05-09-2015
	AUTOR MODIFIC		: TEOFILO CHAMBILLA AQUINO
	CAMBIOS IMPORTANTE	: SE AGREGAR CONSULTA POR MESES
*/
SET NOCOUNT OFF;
...
--UPDATE TOTALEJECUTADO
  	UPDATE #TABLE_TEMP_E SET
 		TOTALEJECTUADO = ENERO +FEBRERO +MARZO +ABRIL +MAYO +JUNIO +JULIO +AGOSTO +SEPTIEMBRE +OCTUBRE +NOVIEMBRE +DICIEMBRE
 	FROM #TABLE_TEMP_E 
 
--UPDATE SALDOEJERCICIO
 	UPDATE #TABLE_TEMP_E SET
 		SADOEJERCICIO=(MEGA_DEC_PIM-TOTALEJECTUADO)
 	FROM #TABLE_TEMP_E 
