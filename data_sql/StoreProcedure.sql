...
+	DESCRIPCION			: REPORTE METAS CON ESPECIFICAS DE GASTOS (PIM CON MODIFICACIONES)
+	FECHA				: 13-09-2015
...
+	DESCRIPCION			: REPORTE DE LOS DETALLES DE CONTROL PRESUPUESTAL SEGÚN LA ID DE CONTROL PRESUPUESTAL
+	FECHA				: 13-09-2015
+	AUTOR				: EDÚ VERA ALVAREZ
+	ARGUMENTOS			:
+	FEC. MODIFIC		: 
...
GO
CREATE PROCEDURE USP_I_SICOP_ESPECIFICADEGASTO
(
	@EGAS_VCH_IDESPECIFICADEGASTO varchar(13),
...
+	DESCRIPCION			: MUESTRA TODAS LAS ESPECIFICAS DE GASTO
+	FECHA				: 13-09-2015
+	AUTOR				: EDÚ VERA ALVAREZ
+	ARGUMENTOS			:
+	FEC. MODIFIC		: 
...
+	DESCRIPCION			: MUESTRA TODAS LAS METAS
+	FECHA				: 13-09-2015
+	AUTOR				: EDÚ VERA ALVAREZ
+	ARGUMENTOS			:
+	FEC. MODIFIC		: 
...
+	DESCRIPCION			: MUESTRA TODOS LOS DOCUMENTOS
+	FECHA				: 13-09-2015
+	AUTOR				: EDÚ VERA ALVAREZ
+	ARGUMENTOS			:
+	FEC. MODIFIC		: 
...
GO
CREATE PROCEDURE USP_I_SICOP_META_ESPECIFICADEGASTO
(
	@META_VCH_IDMETA varchar(4),
	@EGAS_VCH_IDESPECIFICADEGASTO varchar(13),
	@MEGA_VCH_ANIO varchar(4),
...
GO
CREATE PROCEDURE USP_I_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES
(
	@META_VCH_IDMETA varchar(4),
	@EGAS_VCH_IDESPECIFICADEGASTO varchar(13),
...
GO
CREATE PROCEDURE USP_I_SICOP_CONTROLPRESUPUESTAL
...
GO
CREATE PROCEDURE USP_I_SICOP_DETALLECONTROLPRESUPUESTAL
(
	@CPRE_INT_IDCONTROLPRESUPUESTAL INT,
	@EGAS_VCH_IDESPECIFICADEGASTO VARCHAR(13),
	@META_VCH_IDMETA VARCHAR(4),
...
IF OBJECT_ID ( 'USP_L_SICOP_USUARIO', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_L_SICOP_USUARIO
GO
