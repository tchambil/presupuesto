--/////////////////////////////////////////////////////////
--USP_S_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES
--/////////////////////////////////////////////////////////

IF OBJECT_ID ( 'USP_S_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_S_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES
GO

CREATE PROCEDURE [dbo].[USP_S_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES]
(
...
AS
/*
+	NOMBRE				: USP_S_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES
...
--/////////////////////////////////////////////////////////
--USP_S_SICOP_DETALLECONTROLPRESUPUESTAL
--/////////////////////////////////////////////////////////

IF OBJECT_ID ( 'USP_S_SICOP_DETALLECONTROLPRESUPUESTAL', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_S_SICOP_DETALLECONTROLPRESUPUESTAL
GO
CREATE PROCEDURE [dbo].[USP_S_SICOP_DETALLECONTROLPRESUPUESTAL]
(
	@CPRE_INT_IDCONTROLPRESUPUESTAL INT 
...
AS
/*
+	NOMBRE				: USP_S_SICOP_DETALLECONTROLPRESUPUESTAL
...
-----------------------------------------------------------------------------------------------
EXEC USP_S_SICOP_CONTROLPRESUPUESTAL_REPORT '2014'
--/////////////////////////////////////////////////////////
...
+	FECHA				: 13-09-2015
+	AUTOR				: Teófilo Chambilla Aquino
+	ARGUMENTOS			:
+	FEC. MODIFIC		: 
+	AUTOR MODIFIC		: 
+	CAMBIOS IMPORTANTE	: 
...
(SELECT DCPR_DEC_IMPORTE   
 	...
 	FROM dbo.SICOP_CONTROLPRESUPUESTAL CP,
		 ...
		 WHERE  CP.EGAS_VCH_IDESPECIFICADEGASTO =EGA.EGAS_VCH_IDESPECIFICADEGASTO AND
		 		CP.DOCU_INT_IDDOCUMENTO =DOC.DOCU_INT_IDDOCUMENTO AND
		 		YEAR(CP.CPRE_DAT_FECHAINGRESO)=@CPRE_DAT_ANIO;
...
--/////////////////////////////////////////////////////////
--USP_S_SICOP_CONTROLPRESUPUESTAL
--/////////////////////////////////////////////////////////

IF OBJECT_ID ( 'USP_S_SICOP_CONTROLPRESUPUESTAL', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_S_SICOP_CONTROLPRESUPUESTAL
GO
CREATE PROCEDURE [dbo].[USP_S_SICOP_CONTROLPRESUPUESTAL]
AS
/*
+	NOMBRE				: USP_S_SICOP_CONTROLPRESUPUESTAL
+	DESCRIPCION			: REPORTE DE LOS CONTROLES PRESUPUESTALES 
+	FECHA				: 13-09-2015
+	AUTOR				: Teófilo Chambilla Aquino
+	ARGUMENTOS			:
...
AS
/*
+	NOMBRE				: USP_S_SICOP_META_ESPECIFICADEGASTO_REPORT
...
FROM SICOP_META_ESPECIFICADEGASTO MEGA
	WHERE MEGA.META_VCH_IDMETA=@_META_VCH_IDMETA AND
		  MEGA.MEGA_VCH_ANIO=@_MEGA_VCH_ANIO
...
--UPDATE PRESUPUESTO
 	...
 	UPDATE #TABLE_TEMP_E SET
 		SADOEJERCICIO=(MEGA_PRESUPUESTO-TOTALEJECUTADO)
 	FROM #TABLE_TEMP_E 
...
--/////////////////////////////////////////////////////////
--USP_S_SICOP_ESPECIFICADEGASTO
--/////////////////////////////////////////////////////////

IF OBJECT_ID ( 'USP_S_SICOP_ESPECIFICADEGASTO', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_S_SICOP_ESPECIFICADEGASTO
GO
CREATE PROCEDURE [dbo].[USP_S_SICOP_ESPECIFICADEGASTO]
AS
/*
+	NOMBRE				: USP_S_SICOP_ESPECIFICADEGASTO
...
IF OBJECT_ID ( 'USP_S_SICOP_META', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_S_SICOP_META
GO
CREATE PROCEDURE [dbo].[USP_S_SICOP_META]
AS
/*
+	NOMBRE				: USP_S_SICOP_META
...
--/////////////////////////////////////////////////////////
--USP_S_SICOP_DOCUMENTO
--/////////////////////////////////////////////////////////

IF OBJECT_ID ( 'USP_S_SICOP_DOCUMENTO', 'P' ) IS NOT NULL 
    DROP PROCEDURE USP_S_SICOP_DOCUMENTO
GO
CREATE PROCEDURE [dbo].[USP_S_SICOP_DOCUMENTO]
AS
/*
+	NOMBRE				: USP_S_SICOP_DOCUMENTO
...
AS
/*
+	NOMBRE				: USP_D_SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES
+	DESCRIPCION			: ELIMINA UNA NUEVA MODIFICACIÓN AL PIM ANTES INGRESADO A DETERMINADA META SEGÚN LA ESPECIFICA DE GASTO Y EL AÑO
+	FECHA				: 13-09-2015
+	AUTOR				: EDÚ VERA ALVAREZ
+	ARGUMENTOS			:
+	FEC. MODIFIC		: 
...
+	CAMBIOS IMPORTANTE	: 
*/
DELETE SICOP_META_ESPECIFICADEGASTO_MODIFICACIONES WHERE MEGM_INT_IDMODIFICACION=@MEGM_INT_IDMODIFICACION 
GO
