...
EGA.EGAS_VCH_IDESPECIFICADEGASTO AS 'PARTIDA ESPECÍFICA',
...
--ALTER PROC spr_ImportesMensuales
--(
--@ANIO INT
--)
--AS
--SELECT
--IdEspecificaDeGasto = CP.EGAS_VCH_IDESPECIFICADEGASTO
--,Mes = CASE MONTH(CP.CPRE_DAT_FECHAINGRESO)
--WHEN 4 THEN 'ABRIL'
--WHEN 5 THEN 'MAYO'
--WHEN 6 THEN 'JUNIO'
--END
--,Importe = DCP.DCPR_DEC_IMPORTE
--FROM SICOP_CONTROLPRESUPUESTAL CP
--INNER JOIN SICOP_DETALLECONTROLPRESUPUESTAL DCP
--ON CP.CPRE_INT_IDCONTROLPRESUPUESTAL = DCP.CPRE_INT_IDCONTROLPRESUPUESTAL
--WHERE YEAR(CP.CPRE_DAT_FECHAINGRESO) = @ANIO
--GO



--GROUP BY YEAR(CP.CPRE_DAT_FECHAINGRESO), MONTH(CP.CPRE_DAT_FECHAINGRESO)


--select * from SICOP_CONTROLPRESUPUESTAL

--exec spr_ImportesMensuales 2015
...
as
insert into SICOP_META_ESPECIFICADEGASTO(META_VCH_IDMETA, EGAS_VCH_IDESPECIFICADEGASTO, MEGA_DEC_PIM,MEGA_VCH_ANIO) 
values(@META_VCH_IDMETA,@EGAS_VCH_IDESPECIFICADEGASTO, @MEGA_DEC_PIM,@MEGA_VCH_ANIO)
go
